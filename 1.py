...
os.makedirs("ostrich_images", exist_ok=True)

driver = webdriver.Chrome()
driver.get("https://unsplash.com/s/photos/ostrich")
time.sleep(3)
...
for i, url in enumerate(image_urls):
    try:
        ...
        image.save(f"ostrich_images/ostrich_{i+1}.jpg")
        print(f"📥 Saved ostrich_{i+1}.jpg")
