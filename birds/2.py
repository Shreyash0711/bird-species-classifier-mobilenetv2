...
os.makedirs("Flamingo_images", exist_ok=True)

driver = webdriver.Chrome()
driver.get("https://unsplash.com/s/photos/flamingo")
time.sleep(3)
...
for i, url in enumerate(image_urls):
    try:
        ...
        image.save(f"Flamingo_images/flamingo_{i+1}.jpg")
        print(f"📥 Saved flamingo_{i+1}.jpg")
